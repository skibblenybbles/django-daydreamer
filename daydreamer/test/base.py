...
class TestCase(test.TestCase):
    ...
    def assertViewBehavior(self,
        ...
        If method_assertions is specified, it should be a dictionary of
        assertion values to pass to create_method_assertions().
        
        If request_assertions is specified, it should be a dictionary of
        assertion values to pass to create_request_assertions().
        
        If response_assertions is specified, it should be a dictionary of
        assertion values to pass to create_response_assertions().
        ...
        if exception:
            ...
            self.perform_method_assertions(
                method_args, **method_assertions)
            self.perform_request_assertions(
                request, **request_assertions)
            self.perform_response_assertions(
                response, **response_assertions)
    
    def perform_method_assertions(self, method_args, **method_assertions):
        """
        A hook to control the way that method assertions are performed.
    ...
    def perform_request_assertions(self, request, **request_assertions):
        """
        A hook to control the way that request assertions are performed.
    ...
    def perform_response_assertions(self, response, **response_assertions):
        """
        A hook to control the way that response assertions are performed.
    ...
    def create_method_assertions(self):
        """
        A hook for creating method assertions. Must return a tuple of callbacks
        that accept the arguments that were passed to the client to make
        the request.
    ...
    def create_response_assertions(self):
        ...
        callbacks that accept the response that was generated by the request.
